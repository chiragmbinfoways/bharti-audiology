...
class AttributeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $attribute->save();
        if ($attribute) {
            return redirect('jpanel/catalog/attribute/add')->with('success', 'Attribute has been created successfully!');
        } else {
            return redirect('jpanel/catalog/attribute/add')->with('error', 'Something went wrong. Try again.');
        }
    }
    ...
    public function update(Request $request)
    {
        ...
        $attribute = Attribute::where('id', $request->id)->update(['name' => $request->attribute_name, 'slug' => $request->slug]);
        if ($attribute)
            return redirect('jpanel/catalog/attribute/edit/'.$request->id)->with('success', 'Attribute has been updated!');
        else
            return redirect('jpanel/catalog/attribute/edit'.$request->id)->with('error', 'Something went wrong. Try again.');
    }
