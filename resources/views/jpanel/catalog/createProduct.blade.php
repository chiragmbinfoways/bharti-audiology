                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row ">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control-sm category  @error('category') is-invalid @enderror " name="category"
                                                id="cat_id">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control-sm  @error('brand') is-invalid @enderror " name="brand" id="brand_id">
                                ...
                                <div class="row subCategory">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control-sm " name="sub_category" id="sub_cat_id" >
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="summary" class="summernote"></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="">Long Description</label>
                                    <textarea name="long_desc" class="summernote" placeholder="Write Long Description..."></textarea>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-sm @error('price') is-invalid @enderror " id="price"
                                            name="price" placeholder="Enter price" max="10">
                                            @if ($errors->has('price'))
