    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <!-- Default box -->
                 <!-- Profile Update box -->
                 <form action="{{ route('update.settings',$settings->id) }}" method="post">
                    @csrf

                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Edit Setting Add Form</h3>
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm @error('name') is-invalid @enderror" id="name"
                                    name="name" value="{{$settings->name}}" placeholder="Enter name">
                                @if ($errors->has('name'))
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm @error('value') is-invalid @enderror" id="value"
                                    name="value" value="{{$settings->value}}" placeholder="Enter value">
                                @if ($errors->has('value'))
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm @error('laddress') is-invalid @enderror" id="laddress"
                                    name="laddress" value="{{$settings->link}}" placeholder="Enter link address">
